...
Cross-Provider Egress Guard and OPERANT answer different trust questions.

The egress guard asks: "Will this local agent be stopped before sending data to a
destination I did not allow?"
...
Together, they give an operator a control receipt and a calibration receipt.
