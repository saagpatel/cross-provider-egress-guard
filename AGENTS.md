...
egress-guard-oss (published as cross-provider-egress-guard) is destination-aware, default-deny egress control for AI coding agents, enforced at the hook layer across providers. Public on GitHub with an adoption kit; launch-prep hygiene is merged.
